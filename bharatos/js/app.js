...
<div class="text-slate-300">Type 'help' to inspect kernel capabilities.</div>`;
        ...
        const INDIC_I18N = {
            en: {
                app_chitram: "Chitram Paint",
                app_aryabhata: "Aryabhata Math",
                app_sangeet: "Sur Sangeet",
                app_chanakya: "Chanakya AI",
                lock_welcome: "WELCOME TO SOVEREIGN SPACE",
                dock_terminal: "Terminal",
                dock_files: "Files",
                dock_store: "App Store",
                dock_settings: "Settings"
            },
            hi: {
                app_chitram: "चित्रम् चित्रकला",
                app_aryabhata: "आर्यभट्ट गणित",
                app_sangeet: "सुर संगीत",
                app_chanakya: "चाणक्य एआई",
                lock_welcome: "सर्वप्रभुत्व सम्पन्न डिजिटल भारत",
                dock_terminal: "टर्मिनल",
                dock_files: "फ़ाइलें",
                dock_store: "ऐप्लिकेशन स्टोर",
                dock_settings: "सेटिंग्स"
            },
            sa: {
                app_chitram: "चित्रम् कलाशाला",
                app_aryabhata: "आर्यभट गणितशास्त्रम्",
                app_sangeet: "स्वर सङ्गीतम्",
                app_chanakya: "चाणक्य धीमत्ता",
                lock_welcome: "स्वागतम् सम्प्रभुतायाम्",
                dock_terminal: "आदेशपीठम्",
                dock_files: "सञ्चिकाः",
                dock_store: "अनुप्रयोग आपणम्",
                dock_settings: "व्यवस्था"
            },
            ta: {
                app_chitram: "சித்திரம் ஓவியம்",
                app_aryabhata: "ஆரியபட்டா கணிதம்",
                app_sangeet: "சுர சங்கீதம்",
                app_chanakya: "சாணக்யா ஏஐ",
                lock_welcome: "இறைமையுள்ள உலகிற்கு நல்வரவு",
                dock_terminal: "முனையம்",
                dock_files: "கோப்புகள்",
                dock_store: "செயலி அங்காடி",
                dock_settings: "அமைப்புகள்"
            },
            te: {
                app_chitram: "చిత్రం ఆర్ట్",
                app_aryabhata: "ఆర్యభట గణితం",
                app_sangeet: "స్వర సంగీతం",
                app_chanakya: "చాణక్య ఏఐ",
                lock_welcome: "స్వాగతం",
                dock_terminal: "టెర్మినల్",
                dock_files: "ఫైళ్లు",
                dock_store: "యాప్ స్టోర్",
                dock_settings: "సెట్టింగులు"
            },
            bn: {
                app_chitram: "চিত্রশিল্প",
                app_aryabhata: "আর্যভট্ট গণিত",
                app_sangeet: "সুর সঙ্গীত",
                app_chanakya: "চাণক্য এআই",
                lock_welcome: "স্বাগতম",
                dock_terminal: "টার্মিনাল",
                dock_files: "ফাইল",
                dock_store: "অ্যাপ স্টোর",
                dock_settings: "সেটিংস"
            },
            mr: {
                app_chitram: "चित्रम् कला",
                app_aryabhata: "आर्यभट्ट गणित",
                app_sangeet: "सूर संगीत",
                app_chanakya: "चाणक्य एआय",
                lock_welcome: "स्वागत आहे",
                dock_terminal: "टर्मिनल",
                dock_files: "फायली",
                dock_store: "अॅप स्टोअर",
                dock_settings: "सेटिंग्ज"
            },
            gu: {
                app_chitram: "ચિત્રમ આર્ટ",
                app_aryabhata: "આર્યભટ્ટ ગણિત",
                app_sangeet: "સુર સંગીત",
                app_chanakya: "ચાણક્ય એઆઈ",
                lock_welcome: "સ્વાગત છે",
                dock_terminal: "ટર્મિનલ",
                dock_files: "ફાઇલો",
                dock_store: "એપ સ્ટોર",
                dock_settings: "સેટિંગ્સ"
            }
        };

        function changeOSLanguage(langCode) {
            const dict = INDIC_I18N[langCode] || INDIC_I18N.en;
            ...
            showToastNotification('Language Updated', `Switched OS language to ${langCode.toUpperCase()}`);
        }
        ...
        function sendChanakyaMessage() {
            const input = document.getElementById('chanakya-input');
            const messagesContainer = document.getElementById('chanakya-messages');
            ...
            userBubble.innerHTML = `
                <div class="p-3 rounded-2xl bg-cyan-500/20 border border-cyan-500/40 text-cyan-200 max-w-[85%]">
            ...
            // Generate AI Response & Dispatch System Commands
            setTimeout(() => {
                const response = processChanakyaAI(userQuery);
                const aiBubble = document.createElement('div');
                aiBubble.className = "flex items-start space-x-2.5";
                aiBubble.innerHTML = `
                    <div class="w-7 h-7 rounded-xl bg-gradient-to-tr from-cyan-400 to-emerald-400 flex items-center justify-center text-sm text-slate-950 font-bold shrink-0 shadow">
                        🤖
                    </div>
        ...
        function processChanakyaAI(query) {
            const q = query.toLowerCase();

            // 1. Wallpaper Commands
            if (q.includes('ladakh') || q.includes('pangong')) {
                setWallpaper('wallpapers/ladakh_pangong.jpg');
                return "🏔️ <strong>Done!</strong> Set desktop wallpaper to <em>Ladakh Pangong Tso</em>.";
            }
            if (q.includes('kashmir') || q.includes('dal')) {
                setWallpaper('wallpapers/kashmir_dal.jpg');
                return "🛶 <strong>Done!</strong> Set desktop wallpaper to <em>Kashmir Dal Lake</em>.";
            }
            if (q.includes('varanasi') || q.includes('ghat')) {
                setWallpaper('wallpapers/varanasi_dawn.jpg');
                return "🛕 <strong>Done!</strong> Set desktop wallpaper to <em>Varanasi Dawn Ghats</em>.";
            }
            if (q.includes('wallpaper')) {
                setWallpaper('wallpapers/munnar_hills.jpg');
                return "🌿 <strong>Wallpaper updated</strong> to <em>Munnar Hills</em>.";
            }

            // 2. Launch Apps
            if (q.includes('aryabhata') || q.includes('calc')) {
                openAppWindow('aryabhata-window', 'dock-aryabhata');
                return "🧮 Opened <strong>Aryabhata Scientific Suite</strong>.";
            }
            if (q.includes('chitram') || q.includes('paint') || q.includes('draw')) {
                openAppWindow('chitram-window', 'dock-chitram');
                return "🎨 Opened <strong>Chitram Paint Studio</strong>.";
            }
            if (q.includes('sangeet') || q.includes('music') || q.includes('synth')) {
                openAppWindow('sangeet-window', 'dock-sangeet');
                return "🎵 Opened <strong>Sur Sangeet DSP Synthesizer</strong>.";
            }
            if (q.includes('ide') || q.includes('code') || q.includes('studio')) {
                openAppWindow('indic-ide-window', 'dock-indic-ide');
                return "💻 Opened <strong>Indic Code Studio IDE</strong>.";
            }
            if (q.includes('terminal') || q.includes('bash')) {
                openAppWindow('terminal-window', 'dock-terminal');
                return "📟 Opened <strong>Sovereign Ring-0 Terminal</strong>.";
            }

            // 3. Language
            if (q.includes('hindi') || q.includes('हिन्दी')) {
                changeOSLanguage('hi');
                document.getElementById('os-lang-select').value = 'hi';
                return "🇮🇳 प्रणाली भाषा <strong>हिन्दी</strong> में परिवर्तित की गई।";
            }
            if (q.includes('sanskrit') || q.includes('संस्कृत')) {
                changeOSLanguage('sa');
                document.getElementById('os-lang-select').value = 'sa';
                return "🕉️ प्रणाली भाषा <strong>संस्कृतम्</strong> मध्ये परिवर्तिता।";
            }

            // 4. Code Generation
            if (q.includes('idt') || q.includes('kernel') || q.includes('interrupt')) {
                return `💻 <strong>Freestanding IDT Handler (C):</strong>
<pre class="p-2 rounded bg-slate-950 text-cyan-300 font-mono text-[10px] overflow-x-auto">
struct idt_entry {
    uint16_t base_low;
    uint16_t sel;
    uint8_t  always0;
...
void idt_set_gate(uint8_t num, uint32_t base, uint16_t sel, uint8_t flags) {
    ...
    idt[num].flags     = flags;
            ...
            // 5. Kavach Architecture
            if (q.includes('kavach') || q.includes('security') || q.includes('zero-trust')) {
                return "🛡️ <strong>Kavach Architecture:</strong> Operates at Hardware Ring-0 with zero telemetry. Cryptographic golden master seals guarantee tamper resistance and local cryptographic verification.";
            }

            // Default Intelligent Response
            return `✨ I have processed your instruction: "<em>${escapeHTML(query)}</em>". BharatOS sovereign enclave is running at 100% genuine integrity.`;
        }

        function clearChanakyaChat() {
            const m = document.getElementById('chanakya-messages');
            if (m) {
                m.innerHTML = '<div class="text-slate-500 font-mono text-center py-4">Chat cleared.</div>';
            }
        }

        // // 🎨 CHITRAM VECTOR PAINT STUDIO ENGINE
        let chitramCtx = null;
        let chitramDrawing = false;
        ...
        function initChitramCanvas() {
            ...
            if (!canvas) return;
            chitramCtx = canvas.getContext('2d');
            chitramCtx.lineCap = 'round';
            chitramCtx.lineJoin = 'round';
            chitramCtx.fillStyle = '#0f172a';
            chitramCtx.fillRect(0, 0, canvas.width, canvas.height);

            canvas.addEventListener('mousedown', startChitramDraw);
            canvas.addEventListener('mousemove', drawChitram);
            canvas.addEventListener('mouseup', stopChitramDraw);
            canvas.addEventListener('mouseleave', stopChitramDraw);
        }

        function setChitramTool(t) {
            chitramTool = t;
            ['brush', 'eraser', 'line', 'rect', 'circle'].forEach(id => {
        ...
        function setChitramColor(c) {
            chitramColor = c;
            const custom = document.getElementById('chitram-custom-color');
            if (custom) custom.value = c;
        }

        function startChitramDraw(e) {
            if (!chitramCtx) initChitramCanvas();
            const canvas = document.getElementById('chitram-canvas');
            const rect = canvas.getBoundingClientRect();
            startX = e.clientX - rect.left;
            startY = e.clientY - rect.top;
            chitramDrawing = true;
            chitramSnapshot = chitramCtx.getImageData(0, 0, canvas.width, canvas.height);
            chitramCtx.beginPath();
            chitramCtx.moveTo(startX, startY);
        }

        function drawChitram(e) {
            if (!chitramDrawing || !chitramCtx) return;
            const canvas = document.getElementById('chitram-canvas');
            const rect = canvas.getBoundingClientRect();
            ...
            chitramCtx.lineWidth = size;

            if (chitramTool === 'brush') {
                chitramCtx.strokeStyle = chitramColor;
                chitramCtx.lineTo(curX, curY);
                chitramCtx.stroke();
            } else if (chitramTool === 'eraser') {
                chitramCtx.strokeStyle = '#0f172a';
                chitramCtx.lineTo(curX, curY);
                chitramCtx.stroke();
            } else if (chitramTool === 'line') {
                chitramCtx.putImageData(chitramSnapshot, 0, 0);
                chitramCtx.beginPath();
                chitramCtx.strokeStyle = chitramColor;
                chitramCtx.moveTo(startX, startY);
                chitramCtx.lineTo(curX, curY);
                ...
                chitramCtx.putImageData(chitramSnapshot, 0, 0);
                chitramCtx.strokeStyle = chitramColor;
                chitramCtx.strokeRect(startX, startY, curX - startX, curY - startY);
            } else if (chitramTool === 'circle') {
                chitramCtx.putImageData(chitramSnapshot, 0, 0);
                chitramCtx.beginPath();
                chitramCtx.strokeStyle = chitramColor;
                const r = Math.sqrt(Math.pow(curX - startX, 2) + Math.pow(curY - startY, 2));
                chitramCtx.arc(startX, startY, r, 0, Math.PI * 2);
                chitramCtx.stroke();
            }
        }

        function stopChitramDraw() {
            chitramDrawing = false;
        }

        function clearChitramCanvas() {
            const canvas = document.getElementById('chitram-canvas');
            if (canvas && chitramCtx) {
                chitramCtx.fillStyle = '#0f172a';
                chitramCtx.fillRect(0, 0, canvas.width, canvas.height);
            }
        }
        ...
        function exportChitramPNG() {
            ...
            link.download = 'chitram_artwork.png';
            link.href = canvas.toDataURL();
            link.click();
            showToastNotification('Artwork Exported', 'Downloaded chitram_artwork.png');
        }

        // // 🧮 ARYABHATA SCIENTIFIC CALCULATOR & 2D GRAPHER
        let aryabhataCurrentExpr = "";

        function aryabhataNum(n) {
            aryabhataCurrentExpr += n;
        ...
        function aryabhataClear() {
            ...
            document.getElementById('aryabhata-formula').textContent = "";
            document.getElementById('aryabhata-display').textContent = "0";
        ...
        function aryabhataEquals() {
            try {
                document.getElementById('aryabhata-formula').textContent = aryabhataCurrentExpr + " =";
                const sanitized = aryabhataCurrentExpr.replace(/Math\.PI/g, Math.PI).replace(/Math\.E/g, Math.E);
                const result = Function('"use strict";return (' + sanitized + ')')();
                aryabhataCurrentExpr = String(result);
                document.getElementById('aryabhata-display').textContent = result;
                updateProgrammerBases(Math.floor(result));
            } catch (err) {
                document.getElementById('aryabhata-display').textContent = "Error";
            }
        }
        ...
        function updateProgrammerBases(val) {
            ...
            document.getElementById('ary-hex').textContent = '0x' + num.toString(16).toUpperCase();
            document.getElementById('ary-dec').textContent = String(num);
            document.getElementById('ary-bin').textContent = '0b' + num.toString(2);
            document.getElementById('ary-oct').textContent = '0o' + num.toString(8);
        }
        ...
        function switchAryabhataTab(tab) {
            ...
            if (tab === 'calc') {
                ...
                tabCalc.className = "flex-1 py-2 text-center font-bold text-indigo-400 border-b-2 border-indigo-400";
                tabGraph.className = "flex-1 py-2 text-center text-slate-400 hover:text-slate-200";
            } else {
                calcView.classList.add('hidden');
                graphView.classList.remove('hidden');
                tabGraph.className = "flex-1 py-2 text-center font-bold text-indigo-400 border-b-2 border-indigo-400";
                tabCalc.className = "flex-1 py-2 text-center text-slate-400 hover:text-slate-200";
                plotAryabhataGraph();
            }
        }
        ...
        function plotAryabhataGraph() {
            ...
            const expr = document.getElementById('graph-func-input').value;
            ...
            for (let px = 0; px < w; px += 2) {
                const x = (px - w / 2) / 30; // Scale
                try {
                    const y = Function('x', '"use strict";return (' + expr + ')')(x);
                    const py = h / 2 - y * 30;
                    if (first) {
                        ctx.moveTo(px, py);
                        first = false;
        ...
        // // 🎵 SUR SANGEET DSP SYNTHESIZER ENGINE
        ...
        function playSynthNote(note) {
            ...
            const baseFreq = NOTE_FREQ_MAP[note] || 440;
        ...
        function stopSynthNote() {
            if (activeOscillator) {
                try {
                    const ctx = getSynthAudioCtx();
                    activeOscillator.gain.gain.exponentialRampToValueAtTime(0.001, ctx.currentTime + 0.1);
                    activeOscillator.osc.stop(ctx.currentTime + 0.1);
                } catch(e) {}
        ...
        function playSolfeggioTone(freq) {
            ...
            renderWaveVisualizer(freq);
            showToastNotification('Solfeggio Harmonic', `Emitting ${freq} Hz resonant frequency`);
        }

        function adjustSynthOctave(delta) {
            synthOctave = Math.max(1, Math.min(7, synthOctave + delta));
            document.getElementById('synth-octave-disp').textContent = synthOctave;
        }

        function renderWaveVisualizer(freq) {
            ...
            for (let x = 0; x < canvas.width; x++) {
                const y = canvas.height / 2 + Math.sin(x * 0.08 * (freq / 200)) * (canvas.height / 3);
        ...
        // // ⚡ LIVE CODE RUNNER & SANDBOX IN INDIC CODE STUDIO
        function runIndicCodeSandbox() {
            const editor = document.getElementById('indic-code-editor');
            const term = document.getElementById('terminal-body');
            if (!editor) return;

            const code = editor.value;
            showToastNotification('Running Code', 'Executing in sovereign sandbox...');

            // If terminal is open or user wants console output
            let output = "";
            ...
            openAppWindow('terminal-window', 'dock-terminal');
            appendTerminalOutput(`[INDIC STUDIO RUNNER]\n${output}`);
        }
